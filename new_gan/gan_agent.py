...
class GANAgent(object):
    ...
    def compute_intrinsic_reward(self, obs):
        ...
        reconstructed_img, _, _ = self.netG(obs*255)
        #embedding = embedding.squeeze()
        #reconstructed_embedding = reconstructed_embedding.squeeze()
        
        intrinsic_reward = (obs*255 - reconstructed_img).abs().sum((3,2,1)) # Not use reconstructed loss
    ...
    def train_model(self, s_batch, target_ext_batch, target_int_batch, y_batch, adv_batch, next_obs_batch, old_policy):
        ...
        for i in range(self.epoch):
            ...
            for j in range(int(len(s_batch) / self.batch_size)):
                ...
                global_grad_norm_(list(self.model.parameters()))# or just norm policy
