...
class Encoder(nn.Module):
  def __init__(self, z_dim=128):
    ...
    main = nn.Sequential(OrderedDict([
        ('paramid-conv0-1->64', nn.Conv2d(1, 32, 4, 2, 1, bias=False)),
        ('paramid-relu0-64', nn.LeakyReLU(0.2, inplace=True)), # output is 64 * 42 * 42

        ('paramid-conv1-64->128', nn.Conv2d(32, 64, 4, 2, 1, bias=False)),
        ('paramid-batchnorm1-128', nn.BatchNorm2d(64)),
        ('paramid-relu1-128', nn.LeakyReLU(0.2, inplace=True)), # output is 128 * 21 * 21

        ('paramid-conv2-128->256', nn.Conv2d(64, 128, 9, 2, 1, bias=False)),
        ('paramid-batchnorm2-256', nn.BatchNorm2d(128)),
        ('paramid-relu2-256', nn.LeakyReLU(0.2, inplace=True)), # output is 256 * 8 * 8

        ('paramid-conv3-256->512', nn.Conv2d(128, 256, 4, 2, 1, bias=False)),
...
class Decoder(nn.Module):
  def __init__(self, z_dim):
    ...
    main = nn.Sequential(OrderedDict([
        ...
        ('paramid-conv3-512->256', nn.ConvTranspose2d(256, 128, 4, 2, 1, bias=False)),
        ('paramid-batchnorm3-256', nn.BatchNorm2d(128)),
        ('paramid-relu3', nn.ReLU(True)),

        ('paramid-conv2-256->128', nn.ConvTranspose2d(128, 64, 9, 2, 1, bias=False)),
        ('paramid-batchnorm2-128', nn.BatchNorm2d(64)),
        ('paramid-relu2-128', nn.ReLU(True)),

        ('paramid-conv1-128->64', nn.ConvTranspose2d(64, 32, 4, 2, 1, bias=False)),
        ('paramid-batchnorm1-64', nn.BatchNorm2d(32)),
        ('paramid-relu1-64', nn.ReLU(True)),

        ('paramid-conv0-64-1', nn.ConvTranspose2d(32, 1, 4, 2, 1, bias=False)),
