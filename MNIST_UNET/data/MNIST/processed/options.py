...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--select_num', type=int, default=300, help='num of choosed image as training set.')
        ...
        self.parser.add_argument('--n_extra_layers', type=int, default=0, help='Number of extra layers on gen and disc')
        self.parser.add_argument('--device', type=str, default='gpu', help='Device: gpu | cpu')
        self.parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        self.parser.add_argument('--ngpu', type=int, default=1, help='number of GPUs to use')
        self.parser.add_argument('--name', type=str, default='MNIST_UNET', help='name of the experiment')
        self.parser.add_argument('--model', type=str, default='with_connection', help='chooses which model to use. ganomaly')
        ...
        self.parser.add_argument('--resume', default='E:\MNIST_UNET\output\MNIST_UNET', help="path to checkpoints (to continue training)")
        ...
        self.parser.add_argument('--use_con_reward', action='store_true', help='whether to use reconstruction as reward.')
        self.isTrain = True
        self.opt = None
