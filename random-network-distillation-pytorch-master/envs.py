...
from gym_minigrid.wrappers import ImgObsWrapper, RGBImgObsWrapper, ReseedWrapper
...
class GridEnvironment(Environment):
    def __init__(
        ...
        self.daemon = True
        self.env = ImgObsWrapper(RGBImgObsWrapper(ReseedWrapper(gym.make(env_id))))
        self.env_id = env_id
        self.is_render = is_render
